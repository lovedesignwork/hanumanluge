        ...
        <Container style={container}>
          ...
          <Section style={alertBanner}>
            <Text style={alertText}>
              You have received a new message from the Hanuman Luge website contact form.
            </Text>
          </Section>
          ...
          <Section style={footer}>
            <Text style={footerText}>
              This email was sent from the Hanuman Luge website contact form.
            </Text>
            <Text style={footerText}>
              © {new Date().getFullYear()} Hanuman Luge. All rights reserved.
            </Text>
          </Section>
        </Container>
      </Body>
