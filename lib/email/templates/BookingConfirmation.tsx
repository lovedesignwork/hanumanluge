...
const baseUrl = process.env.NEXT_PUBLIC_APP_URL || 'https://hanumanluge.com';
...
export const BookingConfirmationEmail = ({
  ...
  const previewText = `Your Hanuman Luge adventure is confirmed! Booking #${bookingRef}`;
        ...
        <Container style={container}>
          ...
          <Section style={successBanner}>
            ...
            <Text style={successSubtitle}>
              Thank you for choosing Hanuman Luge, {customerName}!
            </Text>
          </Section>
          ...
          <Section style={notesSection}>
            ...
            <Text style={noteText}>
              📏 Height requirement: 110cm minimum to ride alone
            </Text>
            <Text style={noteText}>
          ...
          <Section style={contactSection}>
            ...
            <Text style={contactText}>
              📧 Email: <Link href="mailto:support@hanumanluge.com" style={contactLink}>support@hanumanluge.com</Link>
            </Text>
            <Text style={contactText}>
              📞 Phone: <Link href="tel:+66XXXXXXXX" style={contactLink}>[PHONE NUMBER]</Link>
            </Text>
            <Text style={contactText}>
              💬 LINE: @hanumanluge
            </Text>
          ...
          <Section style={footer}>
            ...
            <Text style={footerText}>
              Phuket&apos;s Premier Luge Adventure
            </Text>
            <Row style={socialRow}>
              <Column style={socialCol}>
                <Link href="https://www.facebook.com/hanumanluge" style={socialLink}>
                  Facebook
                </Link>
              </Column>
              <Column style={socialCol}>
                <Link href="https://www.instagram.com/hanumanluge" style={socialLink}>
                  Instagram
                </Link>
              </Column>
            </Row>
            ...
            <Text style={footerCopyright}>
              © 2026 Hanuman Luge. All rights reserved.
            </Text>
          </Section>
        </Container>
      </Body>
