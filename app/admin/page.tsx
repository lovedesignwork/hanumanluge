  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-96">
        <Loader2 className="w-8 h-8 animate-spin text-[#f3c12c]" />
      </div>
    );
  }
    ...
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3 mb-8">
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm">
          <div className="flex items-center gap-2 mb-2">
            <div className="w-8 h-8 bg-[#f3c12c]/20 rounded-lg flex items-center justify-center">
              <CalendarCheck className="w-4 h-4 text-[#030d52]" />
            </div>
            <span className="text-[10px] font-medium text-[#030d52] bg-[#f3c12c]/10 px-1.5 py-0.5 rounded-full">
              Today
            </span>
          </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm">
        <div className="flex items-center justify-between p-6 border-b border-slate-100">
          ...
          <Link
            href="/admin/bookings"
            className="text-sm text-[#030d52] hover:underline flex items-center gap-1"
          >
            View All
                    ...
                    <tr key={booking.id} className="hover:bg-slate-50">
                      <td className="px-6 py-4 whitespace-nowrap">
                        <Link
                          ...
                          className="text-sm font-medium text-[#030d52] hover:underline"
                        >
                          {booking.booking_ref}
                        </Link>
                      </td>
