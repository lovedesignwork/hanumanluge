        ...
        <Container className="relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-[family-name:var(--font-heading)] text-white mb-6">
              All <span className="text-[#f3c12c]">Packages</span>
            </h1>
            <p className="text-lg text-white/70">
              Explore our complete range of luge packages. From standard rides to premium experiences, 
          ...
          <div className="space-y-8">
            {packages.map((pkg, index) => (
              <motion.div
                ...
                className="group"
              >
                <div className="relative bg-[#1a1a1a] rounded-2xl overflow-hidden border border-white/10 hover:border-[#f3c12c]/30 transition-all duration-300">
                  <div className="flex flex-col lg:flex-row">
                    ...
                    <div className="relative h-72 lg:h-auto lg:w-[40%] overflow-hidden">
                      ...
                      <div className="absolute top-4 left-4 flex gap-2">
                        <span className="px-3 py-1 bg-[#05126f] text-black text-sm font-medium rounded-full flex items-center gap-1">
                    ...
                    <div className="relative p-8 lg:p-10 lg:w-[60%]">
                      {/* Package Name */}
                      <h2 className="text-3xl lg:text-4xl font-[family-name:var(--font-heading)] text-white mb-4 group-hover:text-[#f3c12c] transition-colors">
                        {pkg.name}
                      </h2>
                        ...
                        <div className="grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-5 gap-4 mb-6">
                          {Object.entries(pkg.stats).slice(0, 5).map(([key, value]) => (
                            <div key={key} className="text-center p-3 bg-white/5 rounded-xl">
                              <div className="text-2xl font-bold text-[#f3c12c]">{value}</div>
                      ...
                      <div className="flex flex-wrap gap-3 mb-6">
                        ...
                        {pkg.includesTransfer && (
                          <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#f3c12c]/10 text-[#f3c12c] text-sm">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-6">
                          {pkg.highlights.slice(0, 4).map((highlight, idx) => (
                            <div key={idx} className="flex items-center gap-2 text-white/70 text-sm">
                              <Check className="w-4 h-4 text-[#f3c12c] flex-shrink-0" />
                              {highlight}
                            </div>
                          ))}
                        </div>
                      ...
                      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pt-6 border-t border-white/10">
                        <div>
                          ...
                          <div className="text-3xl font-bold text-[#f3c12c]">
                        ...
                        <Link href={`/packages/${pkg.slug}`}>
                          <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="flex items-center gap-2 px-8 py-4 bg-[#05126f] hover:bg-[#030d52] text-black font-medium rounded-full transition-all shadow-lg hover:shadow-[#05126f]/30"
                          >
                            View Details
        ...
        <Container>
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-[family-name:var(--font-heading)] text-white mb-4">
              Why Choose <span className="text-[#f3c12c]">Hanuman Luge</span>?
            </h2>
            <p className="text-white/60 mb-8">
              Experience Phuket&apos;s ultimate luge adventure. Our packages offer incredible value with 
              professional guides and unforgettable memories.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-6 bg-[#0f0f0f] rounded-xl border border-white/10">
                <div className="w-12 h-12 bg-[#f3c12c]/10 rounded-xl flex items-center justify-center mb-4 mx-auto">
                  <Star className="w-6 h-6 text-[#f3c12c]" />
                </div>
              ...
              <div className="p-6 bg-[#0f0f0f] rounded-xl border border-white/10">
                <div className="w-12 h-12 bg-[#f3c12c]/10 rounded-xl flex items-center justify-center mb-4 mx-auto">
                  <Bus className="w-6 h-6 text-[#f3c12c]" />
                </div>
              ...
              <div className="p-6 bg-[#0f0f0f] rounded-xl border border-white/10">
                <div className="w-12 h-12 bg-[#f3c12c]/10 rounded-xl flex items-center justify-center mb-4 mx-auto">
                  <Users className="w-6 h-6 text-[#f3c12c]" />
                </div>
                <h3 className="text-white font-medium mb-2">All Ages Welcome</h3>
                <p className="text-white/60 text-sm">Perfect for families, couples, and solo adventurers</p>
              </div>
            </div>
          </div>
        </Container>
