    ...
    <div ref={containerRef} className="relative">
      <div className="relative">
        ...
        <button
          ...
          className="w-full h-11 pl-10 pr-3 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 text-sm focus:outline-none focus:border-[#f3c12c] text-left"
        >
      ...
      {isOpen && (
        <div 
          ...
          style={{ border: '3px solid #05126f', minWidth: '340px' }}
        >
          {/* Header */}
              ...
              return (
                <div key={day} className="flex items-center justify-center">
                  <button
                    ...
                    `}
                    style={selected ? { backgroundColor: '#05126f', color: '#000' } : undefined}
                  >
                    {day}
                  </button>
                </div>
