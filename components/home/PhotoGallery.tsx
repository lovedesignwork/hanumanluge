...
const galleryImages = [
  { src: '/images/Gallery/Hanuman%20World%20Phuket%201%20Zipline.JPG', alt: 'Zipline Adventure' },
  { src: '/images/Gallery/Hanuman%20World%20Phuket%202%20Zipline.jpg', alt: 'Forest Canopy' },
  { src: '/images/Gallery/Hanuman%20World%20Phuket%203%20Zipline.jpg', alt: 'Thrilling Heights' },
  { src: '/images/Gallery/Hanuman%20World%20Phuket%204%20Zipline.JPG', alt: 'Sky Bridge' },
  { src: '/images/Gallery/Hanuman%20World%20Phuket%205%20Zipline.JPG', alt: 'Group Fun' },
  { src: '/images/Gallery/Hanuman%20World%20Phuket%206%20Zipline.JPG', alt: 'Scenic Views' },
  { src: '/images/Gallery/Hanuman%20World%20Phuket%207%20Zipline.JPG', alt: 'Adventure Time' },
  { src: '/images/Gallery/Hanuman%20World%20Phuket%208%20Zipline.JPG', alt: 'Jungle Experience' },
];
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <motion.h2
            ...
            className="text-4xl md:text-5xl font-[family-name:var(--font-heading)] text-black mt-6"
          >
            Capture The Moments
          </motion.h2>
          <motion.p
          ...
          >
            Every adventure creates unforgettable memories. Here&apos;s a glimpse of what awaits you.
          </motion.p>
        </div>
        ...
        >
          <a 
            ...
            className="inline-flex items-center gap-3 px-8 py-4 bg-black text-[#f3c12c] font-medium rounded-full hover:bg-[#1a1a1a] transition-colors shadow-xl"
          >
